    ...
    <div className="px-2 md:px-6 lg:px-10">
      ...
      >
        {approachData.map((item, idx) => (
          <SwiperSlide key={idx}>
            <div className="p-5 border-t-4 border-green-800 rounded-xl shadow-md bg-yellow-50 flex flex-col items-center space-y-4 text-center min-h-64 lg:w-56 xl:w-auto">
              ...
              <h3 className="text-xl xl:text-2xl font-bold mb-2 font_dinpro_bold base_text">
                {item.title}
              </h3>
              <p className="text-zinc-800 lg:text-lg xl:text-xl">{item.desc}</p>
            </div>
          </SwiperSlide>
        ))}
      </Swiper>
